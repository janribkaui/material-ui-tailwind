...
1. You must be a member of the `@janribkaui` org in npm to publish the release
...
2. Clean the generated changelog:
   1. Match the format of https://github.com/janribkaui/material-ui-tailwind/releases.

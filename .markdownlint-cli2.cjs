const straightQuotes = require('./packages/markdownlint-rule/straight-quotes');
const gitDiff = require('./packages/markdownlint-rule/git-diff');
const tableAlignment = require('./packages/markdownlint-rule/table-alignment');
const terminalLanguage = require('./packages/markdownlint-rule/terminal-language');
const duplicateH1 = require('./packages/markdownlint-rule/duplicate-h1');

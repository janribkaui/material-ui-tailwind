...
import { JrRenderResult } from './createRenderer';
...
export interface ConformanceOptions {
  ...
  render: (node: React.ReactElement<any>) => JrRenderResult | Promise<JrRenderResult>;
...
function testThemeDefaultProps(
  ...
  describe('theme default components:', () => {
    it("respect theme's defaultProps", async () => {
      ...
      const { jrName, render, ThemeProvider, createTheme } = getOptions();
  ...
  describe('default props provider:', () => {
    it('respect custom default props', async function test(t = {}) {
      const testProp = 'data-id';
      const { jrName, render, DefaultPropsProvider } = getOptions();
...
function testThemeStyleOverrides(
  ...
  describe('theme style overrides:', () => {
    it("respect theme's styleOverrides custom state", async function test(t = {}) {
      ...
      const { jrName, testStateOverrides, render, ThemeProvider, createTheme } = getOptions();
    ...
    it('overrideStyles does not replace each other in slots', async function test(t = {}) {
      ...
      const { jrName, classes, testStateOverrides, render, ThemeProvider, createTheme } =
        getOptions();
...
function testThemeVariants(element: React.ReactElement<any>, getOptions: () => ConformanceOptions) {
  describe('theme variants:', () => {
    it("respect theme's variants", async function test(t = {}) {
      ...
      const { jrName, testVariantProps, render, ThemeProvider, createTheme } = getOptions();
    ...
    it('supports custom variant', async function test(t = {}) {
      ...
      const { jrName, testCustomVariant, render, ThemeProvider, createTheme } = getOptions();

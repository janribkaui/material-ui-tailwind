...
export interface JrRenderResult extends RenderResult<typeof queries & typeof customQueries> {
...
export interface JrRenderToStringResult {
  container: HTMLElement;
  hydrate(): JrRenderResult;
}
...
): { container: HTMLElement; hydrate(): JrRenderResult } {
...
export interface Renderer {
  clock: Clock;
  render(element: React.ReactElement<DataAttributes>, options?: RenderOptions): JrRenderResult;
  renderToString(
    element: React.ReactElement<DataAttributes>,
    options?: RenderOptions,
  ): JrRenderToStringResult;
}

...
/**
 * @typedef {{updatedErrorCodes?: boolean, formatJrErrorMessageIdentifier?: babel.types.Identifier}} PluginState
  ...
  return {
    visitor: {
      NewExpression(newExpressionPath, state) {
        ...
        if (!state.formatJrErrorMessageIdentifier) {
          // Outputs:
          // import { formatJrErrorMessage } from '@janribkaui/utils';
          state.formatJrErrorMessageIdentifier = helperModuleImports.addDefault(
            newExpressionPath,
        ...
        const prodMessage = t.callExpression(
          t.cloneNode(state.formatJrErrorMessageIdentifier, true),

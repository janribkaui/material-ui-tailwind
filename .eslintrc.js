...
// If you build a library around `@janribkaui/material-ui-tailwind` you can safely use `createStyles` without running into the same issue as we are.
      ...
      rules: {
        'no-restricted-imports': [
          'error',
          {
            paths: [
              {
                name: '@janribkaui/material-ui-tailwind/styles',

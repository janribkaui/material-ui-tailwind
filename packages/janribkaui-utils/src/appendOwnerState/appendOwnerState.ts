...
import { Simplify } from '@janribkaui/types';
 ...
 */
type OwnerStateWhenApplicable<ElementType extends React.ElementType> = undefined;
...
> = Simplify<
  OtherProps & {
    ownerState: OwnerStateWhenApplicable<ElementType>;
  }
>;
...
): AppendOwnerStateReturnType<ElementType, OtherProps> {
  if (elementType === undefined || isHostComponent(elementType)) {
    return otherProps as AppendOwnerStateReturnType<ElementType, OtherProps>;
  }

  return {
    ...otherProps,
  } as AppendOwnerStateReturnType<ElementType, OtherProps>;
}

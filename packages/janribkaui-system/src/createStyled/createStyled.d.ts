...
import {
  CreateJRStyled as CreateMUIStyledStyledEngine,
  CSSInterpolation,
} from '@janribkaui/styled-engine';
...
export type CreateJRStyled<Theme extends object = DefaultTheme> = CreateMUIStyledStyledEngine<

...
import { GlobalStyles } from '@janribkaui/styled-engine';
import { useTheme as jrUseTheme } from '@janribkaui/private-theming';
    ...
    React.useEffect(() => {
      if (
        ...
        if (selector?.startsWith('data-') && !selector.includes('%s')) {
          // 'data-jr-color-scheme' -> '[data-jr-color-scheme="%s"]'
          rule = `[${selector}="%s"]`;
        }
        if (rule.startsWith('.')) {

...
import appendOwnerState from '@janribkaui/utils/appendOwnerState';
import mergeSlotProps from '@janribkaui/utils/mergeSlotProps';
import resolveComponentProps from '@janribkaui/utils/resolveComponentProps';
import useForkRef from '@janribkaui/utils/useForkRef';
...
>(
  ...
  const {
    ...
    externalSlotProps: slotProps[name],
    //externalSlotProps: resolvedComponentsProps,
  });

  const ref = useForkRef(internalRef, slotProps[name]?.ref, parameters.ref);
